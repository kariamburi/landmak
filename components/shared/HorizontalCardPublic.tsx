    ...
    {!isDeleted && (
      ...
      >
        ...
        >
          ...
          <div className="ml-1 mb-1 z-5 bottom-0 gap-1 absolute bg-gray-800 bg-opacity-70 text-[10px] text-white right-50 top-100 flex rounded-lg p-1 shadow-sm transition-all">
