...
const FloatingChatIcon: React.FC<FloatingChatIconProps> = ({ onClick, isOpen }) => {
  return (
    <div
      ...
      className="fixed bottom-20 lg:bottom-10 right-2 lg:right-5 z-50 group transform transition-transform duration-500 ease-in-out hover:scale-110 hover:shadow-2xl cursor-pointer outline-none"
    >
      {/* Pulse circle */}
