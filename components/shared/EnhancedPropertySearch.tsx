...
export default function EnhancedPropertySearch({ userId,
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-screen overflow-hidden">
      ...
      {/* Mobile Top Bar */}
      <div className="fixed top-0 left-0 right-0 z-0 bg-white p-0 border-b flex items-center justify-between">
  ...
  `}</style>
            ...
            {/* Map View */}
            <div
              className={`relative transition-all lg:rounded-xl shadow-md border duration-300 overflow-hidden ${showMap ? 'block' : 'hidden'
                }`}
            >
              {isLoaded ? (<><GoogleMap
