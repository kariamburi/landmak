        ...
        <div className="absolute top-2 right-1 z-50 flex flex-col space-y-2 p-2 rounded shadow-md max-h-[90vh] overflow-y-auto">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  className={`w-14 lg:w-full ${selectedControl === "marker" ? "bg-green-600 hover:bg-green-700 text-white" : "text-gray-600"
                    }`}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className={`w-14 lg:w-full ${selectedControl === "polyline" ? "bg-green-600 hover:bg-green-700 text-white" : "text-gray-600"
                    }`}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className={`w-14 lg:w-full ${selectedControl === "polygon" ? "bg-green-600 hover:bg-green-700 text-white" : "text-gray-600"
                    }`}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className={`w-14 lg:w-full ${selectedControl === "none" ? "bg-green-600 hover:bg-green-700 text-white" : "text-gray-600"
                    }`}
