...
export default function Navbar({ userstatus, userId, user, onClose, popup, handleOpenSell, handleOpenChat, handleOpenBook, handleOpenPlan,
  ...
  return (
    <div className="h-[50px] items-center flex pl-2 pr-2 gap-0 w-full border-b bg-gradient-to-b from-green-600 to-green-600 lg:from-[#e4ebeb] lg:to-[#e4ebeb]">
      ...
      <SignedIn>
        <div className="ml-1 w-8 h-8 flex items-center justify-center rounded-full dark:bg-[#131B1E] dark:hover:bg-[#2D3236] bg-white tooltip tooltip-bottom hover:cursor-pointer">
